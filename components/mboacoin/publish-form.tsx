...
// Sauvegarde automatique, seulement en mode "active"
  useEffect(() => {
    ...
    const data = {
      type, title, city, neighborhood, address, residenceId, price, pricePeriod, bedrooms, bathrooms,
    ...
    saveMode, type, title, city, neighborhood, address, residenceId, price, pricePeriod, bedrooms, bathrooms,
    rooms, area, advance, deposit, furnishing, water, electricity,
...
function restoreDraft() {
  ...
  async function submit(e: React.FormEvent<HTMLFormElement>) {
    ...
    const result = await createListing({
      ...
      residenceId: isResidence ? residenceId || null : null,
      price: priceV,
      pricePeriod,
  ...
  return (
    <div className="flex flex-col pb-8">
      ...
      <form onSubmit={submit} className="space-y-6 px-5">
        ...
        {isResidence && (
          <div>
            <label htmlFor="residence" className="field-label">Résidence</label>
            <select
              id="residence"
              value={residenceId}
